...
#    define atomic_cas(ATOMIC_PTR, OLDPTR, NEW) \
       __atomic_compare_exchange_n((ATOMIC_PTR), (OLDPTR), (NEW), false,\
...
#  define atomic_cas(ATOMIC_PTR, OLDPTR, NEW) \
     ((ATOMIC_PTR)->compare_exchange_strong(*(OLDPTR), NEW, std::memory_order_seq_cst, \
